...
<html lang="en">
    <head>
        ...
        <title>Construlita Lighting Awards</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="title-box">
                            <h3 class="text-white m-b-0">Convocatoria</h3>
                        </div>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
        </section>
        <section class="comonSection p-20 p-t-50 ">
            <div class="fullscreen-container p-20">
                <div class="row">
                    <div class="col-lg-4  col-lg-offset-1 col-sm-12 p20">                 
                        <h3 class="amarillo font-bold">ELEGIBILIDAD</h3>
                        <p><b>CONSTRULITA LIGHTING AWARDS</b> es un concurso abierto tanto a talentos emergentes como a profesionales de gran trayectoria. Cualquier persona puede registrarse y publicar un proyecto en nuestra plataforma para que sea evaluado por el jurado, que está compuesto por personalidades destacadas en el mundo de la iluminación profesional, quienes elegirán a los proyectos más destacados.<br>En nuestra cuarta edición logramos reunir un total de 90 proyectos de iluminación desarrollados en distintas partes del mundo. Te invitamos a que permanezcas pendiente de la convocatoria 2020.</p>                        
                    </div>
                    <div class="col-lg-6  col-lg-offset-1 col-lg-pull-1 col-sm-12">
                        <h3 class="amarillo font-bold text-center">CATEGORÍAS</h3>
                        <div class="row">
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/espacios-de-vivienda.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ESPACIOS DE VIVIENDA</h4>
                                <p class="font-13" style="color: #fff;">___________________________________________</p><br>
                            </div>
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/espacios-comerciales.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ESPACIOS COMERCIALES</h4>
                                <p class="font-13" style="color: #fff;">_____________________________________________________________________<br>_____________________________________________________________________</p>
                            </div>
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/espacios-de-hospitalidad.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ESPACIOS DE HOSPITALIDAD</h4>
                                <p class="font-13"style="color: #fff;">_____________________________________________________________________<br>_____________________________________________________________________</p>
                            </div>
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/espacios-productivos-y-educativos.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ESPACIOS DE TRABAJO</h4>
                                <p class="font-13"style="color: #fff;">_____________________________________________________________________<br>_____________________________________________________________________</p>
                            </div>
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/espacios-publicos.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ESPACIOS PÚBLICOS</h4>
                                <p class="font-13"style="color: #fff;">_____________________________________________________________________<br>_____________________________________________________________________</p>
                            </div>
                            <div class="col-lg-2 logospie">
                                <img src="resources/page/images/instalacion-artistica.png" alt="" height="80"/>
                            </div>
                            <div class="col-lg-10">
                                <h4 class="amarillo">ILUMINACIÓN ARTÍSTICA</h4>
                                <p class="font-13"style="color: #fff;">_____________________________________________________________________<br>_____________________________________________________________________</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="p-b-40 footer-map">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><strong class="font-secondary font-14">Email:</strong> <a href="mailto:organizadores@awards.construlitalighting.com">organizadores@awards.construlitalighting.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div> <!-- end row -->
