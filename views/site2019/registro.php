            ...
            <div class="fullscreen-container">
               ...
               <?php
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-sm-12 p-20">
                        <h3>Registro <a href="#" data-wow-duration="700ms" data-wow-delay="450ms" data-toggle="modal" data-target="#tutorial1"><img src="resources/page/images/video-tutorial-color-60.png" alt="" style="max-height: 40px;"><b style="font-size: 14px"> + Pasos para registrarte</b></a></h3>

                        <div class="modal fade" id="tutorial1" tabindex="-1" role="dialog" aria-labelledby="categoria6" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h5 class="">PASOS PARA <b class="amarillo">REGISTRARTE</b></h5>
                                </div>
                                <div class="modal-body">
                                 <div class="col-lg-12 col-sm-12 p-0">
                                     <iframe src="https://player.vimeo.com/video/308485411" width="100%" height="560" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                </div>
                        ...
                        <div class="bg-gray p-20">
                            <form action="create" method="post" id="crearCuenta">
                                <script>
                                    ...
                                    function checkEmailAndSubmit(){
                                        if(document.querySelector("#check1").checked){
                                            if( document.querySelector("#exampleInputEmail1").value.containsAny(["hotmail", "gmail", "live", "outlook", "yahoo"]) ) 
                                                document.querySelector("#crearCuenta").submit();
                                            else {
                                                document.querySelector("#allowEmail").style="background:red;color:white;";
                                                setTimeout(function(){
                                                    document.querySelector("#allowEmail").style=""; 
                                                },5000);
                                            }
                                        }else{
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="name" class="form-control" id="Nombre" aria-describedby="Nombreayuda" placeholder="Nombre" required>
                                </div>
                                <div class="form-group">
                                  <label for="Nombre">Apellidos*</label>
                                  <input type="text" name="lastname" class="form-control" id="Apellido" aria-describedby="Nombreayuda" placeholder="Nombre" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Correo electrónico</label>
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Correo electrónico" required>
                                    <small id="allowEmail">Ingrese un correo electrónico permitido (hotmail, gmail, live, outlook, yahoo)</small>
                                </div>
                                <div class="form-group">
                                  <label for="Contraseña">Contraseña</label>
                                  <input type="password" name="password" class="form-control" id="Contraseñac" placeholder="Contraseña" required>
                                </div>
                                <div class="form-group">
                                  <label for="Contraseña">Confirmar contraseña</label>
                                  <input type="password" name="password2" class="form-control" id="Contraseñac2" placeholder="Contraseña" required>
                                </div>
                                <p><small class="font-13">* Los participantes que se presenten por equipos, empresas o despachos deberán registrar a una persona como representante.</small></p>
                                <div class="form-check p-20">
                                  <input type="checkbox" class="form-check-input" name="heleido" id="Check1" required>
                                  <label class="form-check-label" for="Check1">He leído y estoy de acuerdo con la <a href="http://www.construlitalighting.com/cla/convocatoria" target="_blank" class="amarillo">convocatoria y lineamientos</a> del concurso, así como el <a href="http://grupoconstrulita.com/es_ES/aviso-de-privacidad/" target="_blank" class="amarillo">aviso de privacidad</a> y declaración de <a href="http://www.construlitalighting.com/cla/liberacion-de-materiales" target="_blank" class="amarillo">liberación de materiales.</a></label>
                                </div>
                                <button type="button" onclick="checkEmailAndSubmit()" class="stellarButton">REGISTRARSE</button>
