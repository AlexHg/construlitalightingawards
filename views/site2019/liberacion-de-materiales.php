            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="title-box">
                            <h3 class="text-white m-b-0">DECLARACIÓN DE LIBERACIÓN DE MATERIALES</h3>
                        </div>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
            ...
            <div class="container p-20">
                <div class="row">
                    <div class="col-lg-12 p-b-40">
                        <p>En relación a los materiales empleados para el registro de sus proyectos en Construlita Lighting Awards 2019, el participante que suscribe, declara ser el propietario de los derechos de autor (o actuar a nombre de este) del material y otorga a Construlita Lighting International S.A. de C.V., el derecho no exclusivo para utilizar todas las fotografías, renders, videos, audios, datos sobre el proyecto (excepto los datos clasificados como confidenciales) y materiales presentados al momento del registro a través del portal, para fines promocionales, educativos y de difusión. También autoriza a utilizar las imágenes en medios de comunicación de cualquier tipo, en todo el mundo, de forma permanente.</p>
                        <p>El participante propietario declara que sustenta los derechos de autor sobre los proyectos presentados para la exhibición y distribución de los materiales como parte de la convocatoria de los Construlita Lighting Awards 2019, garantiza y representa que posee todos los derechos o facultades sobre las fotografías, videos y materiales presentados y por este medio declara y mantiene a Construlita Lighting International S.A. de C.V., empresas relacionadas a Grupo Construlita, licenciatarios, colaboradores y cesionarios de las marcas Construlita y Tecno Lite, miembros del jurado, así como a sus empresas y medios asociados, fuera de cualquier controversia ocasionada por perjuicio, reclamo, daño, responsabilidad legal, costos y gastos que surjan de la utilización de los mencionados materiales. El concursante autoriza en este acto el uso de los materiales antes mencionados y registrados en el expediente del proyecto.</p>
                        <p>He leído y acepto las presentes bases, términos y condiciones y es mi deseo participar en Construlita Lighting Awards 2019.</p>
                    </div>
                </div>
            </div>
        </section>
