...
<!-- 									  <div class="stars">
		...
		<section>
			<div class="col-sm-4 col-sm-offset-4 text-center">
				...
				?>
					  <li <?php echo $active; ?>>
					  	<a href="judge?page=<?php echo $x; ?>"><?php echo $x; ?></a>
					  </li>
				<?php
					}
				 ?>
