                    ...
                    <div class="row info-3">
                        ...
                        <div class="row">
                            ...
                            <div class=" form-group col-sm-12 ">
                                <label class="v-middle">Imágenes <span class="label label-danger"></span></label>
                                    <p>Arrastra los archivos o haz click dentro del recuadro para subir imágenes (PNG, JPG, JPEG).<br>Mínimo 3 y máximo 8 imágenes con un peso máximo de 8 MB por imagen.<br>Cada fotografía deberá tener una dimensión mínima a 720 px en alto y ancho.</p>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="col-sm-4  text-center">
                                ...
                                <button  class="btn btn-warning p-top-9 activate-p1" disabled="disabled" id ="postular" onclick="postular()" >POSTULAR</button>
...
<script>
        //redireccionar de nuevo proyecto si ya no es posible agregar uno
         if(parseInt(document.getElementById('days').innerText) <= 0){
             alert("La convocatoria ha terminado, ya no es posible agregar un nuevo proyecto.");
             window.location = "http://www.construlitalighting.com/cla/participante";
         } 
</script>