							...
							<div class="widget">
								<div class="widget-advanced">
									...
									<div class="widget-main">
										...
										<a href="dashboard-project-details?id=<?php echo $project['id_project'];  ?>&stars=<?php echo $stars; ?>" class="btn btn-sm btn-success">Calificación: <?php echo $rate['promedio'] ==  null ? "0":$rate['promedio'] ?></a>
									</div>
									<!-- END Widget Main -->
								</div>
							</div>
