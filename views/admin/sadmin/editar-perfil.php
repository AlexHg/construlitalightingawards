...
<div class="block" id="editarInfo">
    ...
    <form action="update-us" method="POST" class="row" id="update" enctype="multipart/form-data">
        ...
        <div class="form-group col-lg-4">
            ...
            <input type="text" 
                ...
                class="form-control" 
                placeholder="Otro:"
                value="<?php echo ($user['profession'] != "Arquitecto" && $user['profession'] != "Diseñador de Iluminación" && $user['profession'] != "Interiorista" && $user['profession'] != "Ingeniero" && $user['profession'] != "Paisajista" && $user['profession'] != "Urbanista" )?$user['profession']:''; ?>"
            >
        </div>
        <div class="form-group col-lg-4">
