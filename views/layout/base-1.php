				...
				<div class="col-xs-12 col-sm-8 col-lg-8 text-right padding-auto">
					<?php
						if(isset($_SESSION["token_session"])){
							if($_SESSION["rol"] != 0){
							//echo "<a href='list-users' class='btn btn-register text-uppercase'>Usuarios registrados</a> ";
							echo "<a href='proyectos-sin-calificar' class='btn btn-register text-uppercase'>Proyectos sin calificar</a> ";
							echo "<a href='proyectos-calificados' class='btn btn-register text-uppercase'>Proyectos calificados</a> ";
...
<!--     <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script> -->
	...
	<script type="text/javascript" src="assets/js/construlita-1.js"></script>
